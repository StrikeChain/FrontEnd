              ...
              {wallet ? (
                <div className="flex items-center gap-2">
                  ...
                  <div className="hidden md:block">
                    <p className="text-sm font-medium">Micaela</p>
                  </div>
                </div>
              ) : (
                <Link
                  href="/signup"
                  className="bg-gradient-to-r from-[#191D1E] via-[#345D61] to-[#191D1E] hover:bg-opacity-90 text-white px-4 py-2 rounded-md text-sm border border-white/30"
                >
                  Connect Wallet
                </Link>
              )}
